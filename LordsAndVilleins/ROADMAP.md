...
> 当前版本:**v0.1.0**
> 状态:**Code complete, awaiting in-game smoke verification**
> 最后更新:2026-04-22
...
| 模块 | 功能 | 钩子 |
|---|---|---|
| **Economy** | 锁定/置顶 GoldCoins / Grain / Wood / Stone,一键 +1000 | `GameManager.Update` Postfix → `Inventory.AddResource` |
...
### Must
- [ ] **完成游戏内冒烟清单**(`docs/smoke-checklist.md`),把每项实测结果写进本 ROADMAP 的下一节"v0.1.0 in-game verification"
- [ ] **Economy 真锁机制**:`Inventory.SpendResources` 也 patch,使 Lock Gold ON 时金币真的不掉(目前是"top-up 模式" — 资源减了再补,可能瞬间从 99999 → 90000 → 99999 闪一下)
...
- [ ] **资源类型扩展**:目前只 Gold/Grain/Wood/Stone,扩展到所有 ResourceName(可能 100+ 种)— 用可滚动列表 + 搜索
