...
namespace LordsAndVilleinsCheats.Core
{
    ...
    /// BaseUnityPlugin.Update/OnGUI was not firing in this game's host;
    /// running the GUI loop from our own GameObject is the standard fallback.
    /// Diagnostic file writes bypass BepInEx Logger buffering so we can confirm
    /// whether Unity is actually invoking the magic methods.
    /// </summary>
